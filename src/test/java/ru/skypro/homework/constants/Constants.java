...
public class Constants {
    ...
    public static final User ANOTHER_USER_REGISTER = new User(null, "anotheruser@test.com", "Another user name", "Another user lastname", "+75556667788", Role.USER, "user_3.jpg", "456");
