...
import ru.skypro.homework.filter.JwtRequestFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(AuthenticationServiceImpl authenticationService, JwtRequestFilter jwtRequestFilter, PasswordEncoderConfiguration passwordEncoder) {
